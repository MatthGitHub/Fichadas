        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-body">
                  <h4 class="text-center bg-info">Lugares de trabajo</h4>
                <form class="form form-signup" role="form">
      						<div class="form-group">
      							<div class="input-group">
      								<span class="input-group-addon"><h5 class="text-center"><i class="fa fa-user fa-fw"></i> Lugar de trabajo:</h5></span>
                    </div>
                      <input name="lugar" type="text" id="lugar" class="form-control" placeholder="Nuevo lugar" />
      						</div>
                  ...
                  <thead>
                    ...
                    <tbody>
                      <?php while($edificios = sqlsrv_fetch_array( $stmt)){ ?>
                        <tr >
                          <td> <?php echo $edificios['IdLugarTrabajo']; ?> </td>
                          <td> <?php echo $edificios['Descripcion']; ?> </td>
                          <td> <a class="btn btn-primary btn-danger" role="button" legajo="<?php echo $edificios['IdLugarTrabajo'];?>" > Eliminar </a> </td>
                        <?php } ?>
                    </tbody>
        </table>
