...
<html lang="en">
  <head>
    ...
    <title> Motivos entrega tarjeta </title>
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-body">
                  <h4 class="text-center bg-info">Motivos entrega tarjeta</h4>
                <form class="form form-signup" role="form">
      						<div class="form-group">
      							<div class="input-group">
      								<span class="input-group-addon"><h5 class="text-center"><i class="fa fa-user fa-fw"></i> Motivo:</h5></span>
                    </div>
                      <input name="motivo" type="text" id="motivo" class="form-control" placeholder="Nuevo motivo" />
      						</div>
                  ...
                  <thead>
                    ...
                    <tbody>
                      <?php while($edificios = sqlsrv_fetch_array( $stmt)){ ?>
                        <tr >
                          <td> <?php echo $edificios['IdMotivo']; ?> </td>
                          <td> <?php echo $edificios['Descripcion']; ?> </td>
                          <td> <a class="btn btn-primary btn-danger" role="button" legajo="<?php echo $edificios['IdMotivo'];?>" > Eliminar </a> </td>
                        <?php } ?>
                    </tbody>
        </table>
