  ...
  <body>
	<br>
       ...
       <?php include('../inc/menu.php'); ?>
		...
		<div class="jumbotron">
			<h4 class="text-center bg-info">Listado de licencias</h4>
			<div class="container">
				<form name="form1" method="post" action="listado_licencias.php">
				<div class="row">
					<div class="col-md-4 col-md-offset-4">
                        ...
                        <div class="form-group">
           								<div class="input-group">
           									...
           									<input name="desde" type="text" class="form-control"  id="desde" placeholder="Legajo desde" />
           								</div>
           							</div>
                        <div class="form-group">
           								<div class="input-group">
           									<span class="input-group-addon"><i class="fa fa-font fw" aria-hidden="true"></i></span>
           									<input name="hasta" type="text" class="form-control"  id="hasta" placeholder="Legajo hasta" />
           								</div>
           							</div>
											</div>
