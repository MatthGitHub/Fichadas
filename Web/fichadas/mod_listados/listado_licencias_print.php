...
if(($_POST['hd_desde'])&&($_POST['hd_hasta'])&&($_POST['desde'])&&($_POST['hasta'])){
...
//echo "Desde: ".$desde." Hasta: ".$hasta." Desde Legajo: ".$DesdeLegajo." Hasta Legajo: ".$HastaLegajo;
...
if( $stmt === false ) {
  ...
  header("Location: form_listado_licencias.php?errordat");
  exit();
}
