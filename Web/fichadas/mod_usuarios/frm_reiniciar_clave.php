...
<html lang="en">
  ...
  <body>
      ...
      <div class="jumbotron">
		...
		<h4 class="text-center bg-info">Reiniciar Clave</h4>

		<div class="container">
			<form name="form1" method="post" action="reiniciar_clave.php">
			<div class="row">
				<div class="col-md-4 col-md-offset-4">
					<div class="panel panel-default">
						...
						<input type="submit" name="Submit" value="Reiniciar"  class="btn btn-sm btn-primary btn-block">
						</div>
					  </form>
					</div>
