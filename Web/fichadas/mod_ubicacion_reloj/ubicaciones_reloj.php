...
$sql = "SELECT * FROM UBICACIONRELOJ";
        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-body">
                  <h4 class="text-center bg-info">Ubicaciones reloj</h4>
                <form class="form form-signup" role="form">
      						<div class="form-group">
      							<div class="input-group">
      								<span class="input-group-addon"><h5 class="text-center"><i class="fa fa-user fa-fw"></i> Ubicacion reloj:</h5></span>
                    </div>
                      <input name="ubicacion" type="text" id="ubicacion" class="form-control" placeholder="Nueva ubicacion" />
      						</div>
        ...
        <div class="row">
              <table id="example" class="display" cellspacing="0" width="100%">
                  <thead>
                    <th> ID </th>
                    <th> Numero reloj </th>
                    <th> Ubicacion reloj </th>
                    <th> Eliminar </th>
                  </thead>
                    <tbody>
                      <?php while($edificios = sqlsrv_fetch_array( $stmt)){ ?>
                        <tr >
                          <td> <?php echo $edificios['IdReloj']; ?> </td>
                          <td> <?php echo $edificios['NumeroReloj']; ?> </td>
                          <td> <?php echo $edificios['UbicacionReloj']; ?> </td>
