        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="panel panel-default">
                <div class="panel-body">
                  <h4 class="text-center bg-info">Tipos de Empleado</h4>
                <form class="form form-signup" role="form">
      						<div class="form-group">
      							<div class="input-group">
      								<span class="input-group-addon"><h5 class="text-center"><i class="fa fa-user fa-fw"></i> Tipo empleado:</h5></span>
                    </div>
                      <input name="tipoEmp" type="text" id="tipoEmp" class="form-control" placeholder="Nuevo tipo empleado" />
      						</div>
                  ...
                  <thead>
                    ...
                    <tbody>
                      <?php while($edificios = sqlsrv_fetch_array( $stmt)){ ?>
                        <tr >
                          <td> <?php echo $edificios['IdTipoEmpleado']; ?> </td>
                          <td> <?php echo $edificios['Descripcion']; ?> </td>
                          <td> <a class="btn btn-primary btn-danger" role="button" legajo="<?php echo $edificios['IdTipoEmpleado'];?>" > Eliminar </a> </td>
                        <?php } ?>
                    </tbody>
        </table>
