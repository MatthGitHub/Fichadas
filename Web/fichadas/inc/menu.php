...
<div class="container-fluid">
  ...
  <a class="navbar-brand" href="#"><p><img src="../images/escudobrc.gif" alt="Municipalidad Bariloche" align="middle" style="margin:0px 0px 0px 20px"></p>Bienvenido</a>
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-pencil fa-fw"></i> Actualizaciones<span class="caret"></span></a>
            <ul class="dropdown-menu">
                ...
                <li><a href="../mod_licencias/tipo_licencias.php">Tipo de licencias</a></li>
        ...
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-list-alt fa-fw"></i> Operaciones Frecuentes<span class="caret"></span></a>
            <ul class="dropdown-menu">
                ...
                <li><a href="../mod_consulta_general/form_consulta_general.php">Consulta general de fichdas</a></li>
                ...
                <li><a href="../mod_empleados/nuevo_empleado.php">Empleados por lugar de trabajo</a></li>
              </ul>
        </li>
      <?php } ?>
      <?php if(($_SESSION['permiso'] == 0)){ ?>
        <li class="dropdown">
          <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-telegram fa-fw"></i> Licencias <span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="../mod_empleados/form_seleccionar_legajo_tarjeta.php">Registrar Licencia</a></li>
                <li><a href="../mod_control_acceso/form_seleccionar_legajo_control_acceso.php">Consultar estado de licencias</a></li>
              </ul>
        </li>
      <?php } ?>
  </ul>
