...
$query_certificados="select c.id_certificado as certificado,fecha_recibido,legajo,apellido,nombre,m.descripcion as motivo,fecha_inicio,fecha_fin,estado,ce.descripcion as ce_descripcion,descripcion_organigrama_original,descripcion_organigrama from 
